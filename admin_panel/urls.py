...
urlpatterns = [
    ...
    path('add-place-jnerntenrt3i534590293v2oij2343/', views.add_place, name='add-place'),
    path('delete-place-woktokyrono4nvb4353435d2dr2/', views.delete_place, name='delete-place'),
